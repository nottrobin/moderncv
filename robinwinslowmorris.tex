...
Over 18 years in software engineering, I've led the development of high performing full-stack web services and APIs across many languages and technologies including Python (Flask/Django), PostgreSQL, MongoDB and K8s. I've evolved team standards and implemented continuous delivery pipelines.

As a manager, I've formed, led and grown efficient engineering teams with high retention and strong engineering culture. I've designed roles and team structures, improved team interactions, resolved conflicts and worked closely with stakeholders and product owners at all levels.
...
\cventry{11/2023 to present}{Associate Director, operational software engineering}{Oxford Nanopore Technologies}{}{}{\begin{itemize}
\item Acting-head of Operational Software Engineering department for 3 months during the department head\'s sabbatical
\item Lead the Manufacturing Tracking team, optimising manufacturing execution across ONT
\item Doubled team efficiency and delivery, with completely redesigned agile processes and practices
\item Designed and led new EKS-based containerisation architecture for the business-critical telemetry system
\item Mentor engineers and prospective leaders across the Operational Software Engineering department
\item Drove departmental improvements towards certification for the ISO 27001 security audit
\item Central participant in ONT's management and mentoring programmes
\end{itemize}}
